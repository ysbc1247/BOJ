...
int main() {
    ...
    ll arr[1001][3]={};
    ll sm[1001][2] ={};
    arr[1][0] = sm[0][1] = arr[1][1] = arr[1][2] = 1;
    for(ll i=2; i<=n; i++){
        ll tmp = (arr[i-1][0]+arr[i-1][1]+arr[i-1][2])%mod;
        arr[i][0] = (tmp+sm[i-2][1])%mod;
        arr[i][1] = tmp;
        arr[i][2] = (tmp+sm[i-2][0])%mod;
        sm[i-1][1] = sm[i-2][1]+arr[i-1][2];
        sm[i-1][1]%=mod;
        sm[i-1][0] = sm[i-2][0]+arr[i-1][0];
        sm[i-1][0]%=mod;
    }
    cout<<arr[n][0];
}
